 ...
 */
public interface HasDoubleClickListeners<T extends Component>
    ...
    default Registration addDoubleClickListener(
        ...
        return addListener(DoubleClickEvent.class,
     ...
     */
    @DomEvent("dblclick")
    class DoubleClickEvent<C extends Component> extends ComponentEvent<C> {
         ...
         * @see ComponentEvent
         */
        public DoubleClickEvent(C source, boolean fromClient) {
